...
namespace HammingAI
{
    public partial class VoiceAgentsClient
    {
        ...
        {
            var __response = await RunVoiceAgentAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HammingAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HammingAI.AutoSDKHttpResponse<global::HammingAI.RunVoiceAgentResponse>> RunVoiceAgentAsResponseAsync(
            string agentId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HammingAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HammingAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RunVoiceAgentAsync",
                                pathTemplate: "$\"/voice-agent/{agentId}/run\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HammingAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HammingAI.RunVoiceAgentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HammingAI.AutoSDKHttpResponse<global::HammingAI.RunVoiceAgentResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HammingAI.RunVoiceAgentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
