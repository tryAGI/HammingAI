...
namespace HammingAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::HammingAI.AutoSDKRetryOptions Retry { get; set; } = new global::HammingAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::HammingAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::HammingAI.IAutoSDKHook>();
        ...
        public global::HammingAI.AutoSDKClientOptions AddHook(
            global::HammingAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::HammingAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::HammingAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::HammingAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::HammingAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::HammingAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::HammingAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::HammingAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::HammingAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::HammingAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::HammingAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::HammingAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::HammingAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::HammingAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::HammingAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::HammingAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::HammingAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::HammingAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::HammingAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::HammingAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::HammingAI.AutoSDKClientOptions clientOptions,
            global::HammingAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::HammingAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::HammingAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::HammingAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::HammingAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::HammingAI.IAutoSDKHook, global::HammingAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::HammingAI.AutoSDKHookContext context)
        {
