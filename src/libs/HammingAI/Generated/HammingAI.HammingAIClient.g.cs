...
namespace HammingAI
{
    ...
    public sealed partial class HammingAIClient : global::HammingAI.IHammingAIClient, global::System.IDisposable
    {
        ...
        /// 
        /// </summary>
        public global::System.Text.Json.Serialization.JsonSerializerContext JsonSerializerContext { get; set; } = global::HammingAI.SourceGenerationContext.Default;
        ...
        /// 
        /// </summary>
        public MonitoringClient Monitoring => new MonitoringClient(HttpClient, authorizations: Authorizations)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// 
        /// </summary>
        public ScoringClient Scoring => new ScoringClient(HttpClient, authorizations: Authorizations)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// 
        /// </summary>
        public TracingClient Tracing => new TracingClient(HttpClient, authorizations: Authorizations)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// 
        /// </summary>
        public VoiceAgentsClient VoiceAgents => new VoiceAgentsClient(HttpClient, authorizations: Authorizations)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// <summary>
        /// Creates a new instance of the HammingAIClient.
            ...
            bool disposeHttpClient = true)
        {
            ...
            Authorizations = authorizations ?? new global::System.Collections.Generic.List<global::HammingAI.EndPointAuthorization>();
