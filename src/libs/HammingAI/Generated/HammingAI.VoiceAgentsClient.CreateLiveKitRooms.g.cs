...
namespace HammingAI
{
    public partial class VoiceAgentsClient
    {
        ...
        {
            var __response = await CreateLiveKitRoomsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HammingAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HammingAI.AutoSDKHttpResponse<global::HammingAI.CreateLiveKitRoomsResponse>> CreateLiveKitRoomsAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HammingAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HammingAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateLiveKitRoomsAsync",
                                pathTemplate: "\"/test-runs/create-livekit-rooms\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HammingAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HammingAI.CreateLiveKitRoomsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HammingAI.AutoSDKHttpResponse<global::HammingAI.CreateLiveKitRoomsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HammingAI.CreateLiveKitRoomsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
