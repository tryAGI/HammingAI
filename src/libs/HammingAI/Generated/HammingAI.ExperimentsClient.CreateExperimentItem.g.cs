...
namespace HammingAI
{
    public partial class ExperimentsClient
    {
        ...
        partial void PrepareCreateExperimentItemRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string experimentId,
            global::HammingAI.CreateExperimentItemRequest request);
        partial void ProcessCreateExperimentItemResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateExperimentItemResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::HammingAI.CreateExperimentItemResponse> CreateExperimentItemAsync(
            string experimentId,
        ...
        {
            var __response = await CreateExperimentItemAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HammingAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HammingAI.AutoSDKHttpResponse<global::HammingAI.CreateExperimentItemResponse>> CreateExperimentItemAsResponseAsync(
            string experimentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateExperimentItemArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateExperimentItemRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HammingAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HammingAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateExperimentItem",
                                methodName: "CreateExperimentItemAsync",
                                pathTemplate: "$\"/experiments/{experimentId}/items\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateExperimentItemResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HammingAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateExperimentItemResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HammingAI.CreateExperimentItemResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HammingAI.AutoSDKHttpResponse<global::HammingAI.CreateExperimentItemResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HammingAI.CreateExperimentItemResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::HammingAI.CreateExperimentItemResponse> CreateExperimentItemAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HammingAI.CreateExperimentItemRequest
            {
            ...
            return await CreateExperimentItemAsync(
                experimentId: experimentId,
                request: __request,
                requestOptions: requestOptions,
